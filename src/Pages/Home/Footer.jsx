        ...
        <div className="footer_container">
            ...
            <div className="first_section">
                <div className="text_block">
                    ...
                    <div className="icon">
                        <div className="i1"><img src="/logos/fb.svg" alt="" /></div>
                        <div className="i2"><img src="/logos/tw.svg" alt="" /></div>
                        <div className="i3"><img src="/logos/linkedin.svg" alt="" /></div>
                        <div className="i4"><img src="/logos/ig.svg" alt="" /></div>
                    </div>
                 </div>
